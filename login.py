...
login = Label(root,text="log into continue.",font=("Cabiler",23)).place(x=560, y=290)
question = Label(root,text="Don't you have an account?",font=("Cabiler",13)).place(x=560, y=350)
sign_up = Button(root,text="Create a new account.", border=0,font=("Cabiler",13,"underline"), fg="sky blue").place(x=765, y=347)

username = Label(root,text="Username",font=("Cabiler",10)).place(x=560, y=395)
